...
class _ChatScreenState extends State<ChatScreen>
  ...
  List<UsersObject> items = <UsersObject>[
      UsersObject(1, "サッカー", true, true, "", "Rectangle -1.png", ),
      UsersObject(2, "野球", true, true, "", "Rectangle -2.png", ),
      UsersObject(3, "バスケ", false, true, "", "Rectangle -3.png", ),
      UsersObject(4, "テニス", false, false, "", "Rectangle -4.png", ),
      UsersObject(5, "卓球", false, false, "", "Rectangle -5.png", ),
      UsersObject(6, "ゴルフ", false, false, "", "Rectangle -6.png", ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: CustomScrollView(
          slivers: <Widget>[
            SliverPersistentHeader(delegate: PinedHeader(_tabController, onTabTap), pinned: true),
            SliverList(
